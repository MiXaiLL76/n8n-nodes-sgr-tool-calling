/**
 * Default prompt templates for SGR Tool Calling Agent
 */

export const DEFAULT_SYSTEM_PROMPT = `<MAIN_TASK_GUIDELINES>
...
export const DEFAULT_INITIAL_USER_REQUEST = `Current Date: {current_date} (Year-Month-Day ISO format: YYYY-MM-DD HH:MM:SS)
ORIGINAL USER REQUEST:

{task}`;

export const DEFAULT_CLARIFICATION_RESPONSE = `Current Date: {current_date} (Year-Month-Day ISO format: YYYY-MM-DD HH:MM:SS)
